...
parser.add_argument('--output-prefix', dest='fout_prefix', nargs=1,default=run_id, help="prefix of output files")
...
parser.add_argument('--finesse', dest='finesse', help="Controls the element rank", type=int,
                    default=0)
...
if mpiRank == 0 and Silence < 1:
   if args.epsmodel == 'slab':
        ...
        print "------------------------------------------------"
if mpiRank == 0 and Silence < 1:
        print "BDM_level", BDM_level
        print "DG_level", DG_level
        print "------------------------------------------------"
####################################
#Boundaries
####################################
...
BDM = FunctionSpace(mesh, "BDM", BDM_level, constrained_domain=pb)
DG = FunctionSpace(mesh, "DG", DG_level, constrained_domain=pb)
